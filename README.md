...
- **`dash-native-html-integration`**：规范嵌入原生HTML/JS/CSS等复杂定制化网页功能。
- **`fetch-fac-component-names`**：获取有效的fac组件名，避免AI编造不存在的组件。
- **`fetch-fac-component-props-doc`**：精准获取指定fac组件的官方参数文档，以供AI查阅。
